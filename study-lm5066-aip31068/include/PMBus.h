...
namespace a9
{
    ...
    public:
        PMBus()
        {
            ...
            add(0x88, READ, 2, false);                 // READ_VIN Retrieves input voltage measurement R 2 0000h
            add(0x8B, READ, 2, false);                 // READ_VOUT Retrieves output voltage measurement R 2 0000h
            add(0x8D, READ, 2, false);                 // READ_TEMPERATURE_1 Retrieves temperature measurement R 2 0190h
            ...
            add(0xD0, READ, 2, false);                 // MFR_SPECIFIC_00/READ_VAUX Retrieves auxiliary voltage measurement R 2 0000h
            add(0xD1, READ, 2, false);                 // MFR_SPECIFIC_01/MFR_READ_IIN Retrieves input current measurement R 2 0000h
            add(0xD2, READ, 2, false);                 // MFR_SPECIFIC_02/MFR_READ_PIN Retrieves input power measurement R 2 0000h
            add(0xD3, READ | WRITE, 2, false);         // MFR_SPECIFIC_03/MFR_IIN_OC_WARN_LIMIT Retrieves or stores input current limit warn threshold R/W 2 0FFFh
            add(0xD4, READ | WRITE, 2, false);         // MFR_SPECIFIC_04/MFR_PIN_OP_WARN_LIMIT Retrieves or stores input power limit warn threshold R/W 2 0FFFh
            add(0xD5, READ, 2, false);                 // MFR_SPECIFIC_05/READ_PIN_PEAK Retrieves measured peak input power measurement R 2 0000h
            ...
            add(0xDC, READ, 2, false);                 // MFR_SPECIFIC_12/READ_AVG_VIN Retrieves averaged input voltage measurement R 2 0000h
            add(0xDD, READ, 2, false);                 // MFR_SPECIFIC_13/READ_AVG_VOUT Retrieves averaged output voltage measurement R 2 0000h
            add(0xDE, READ, 2, false);                 // MFR_SPECIFIC_14/READ_AVG_IIN Retrieves averaged input current measurement R 2 0000h
            add(0xDF, READ, 2, false);                 // MFR_SPECIFIC_15/READ_AVG_PIN Retrieves averaged input power measurement R 2 0000h
